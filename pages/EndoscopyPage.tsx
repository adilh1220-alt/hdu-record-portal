...
const EndoscopyPage: React.FC<EndoscopyPageProps> = ({ 
  ...
  const [shareRecord, setShareRecord] = useState<EndoscopyRecord | null>(null);
  ...
  const handleOpenShareForCurrentForm = () => {
    const currentRec: EndoscopyRecord = {
      id: editingRecord?.id || `temp_${Date.now()}`,
      serialNo: String(editingRecord?.serialNo || (records.length + 1)),
  ...
  if (isWorkspaceOpen && initialWorkspaceOpen) {
    ...
    return (
                        ...
                        <td className="px-4 py-3 text-right" onClick={(e) => e.stopPropagation()}>
                          <div className="flex items-center justify-end space-x-1">
                            <button 
                              ...
                              className="p-1.5 rounded bg-blue-50 hover:bg-blue-100 text-blue-600 hover:text-blue-800 border border-blue-200 hover:border-blue-300 transition-all cursor-pointer shadow-2xs"
                            ...
                            <button 
                              ...
                              className="p-1.5 rounded bg-emerald-50 hover:bg-emerald-100 text-emerald-600 hover:text-emerald-800 border border-emerald-300 hover:border-emerald-400 transition-all cursor-pointer flex items-center justify-center shadow-2xs active:scale-95"
                              title="Share Endoscopy Report (WhatsApp, Email & Configured Templates)"
                            >
      ...
      {/* Clinical Summary & WhatsApp Multi-Template Share Modal */}
          ...
          <div className="bg-slate-800 border-b border-slate-700 px-6 py-4 flex flex-col sm:flex-row items-center justify-between gap-4 shadow-lg">
            ...
            <div className="flex items-center space-x-3">
              ...
              <button
                type="button"
                onClick={() => {
                  handleOpenShareForCurrentForm();
                }}
                className="px-4 py-2 bg-emerald-600 hover:bg-emerald-500 text-white rounded-lg text-[10px] font-black uppercase tracking-widest border border-emerald-500/50 transition-all cursor-pointer active:scale-95 flex items-center space-x-1.5 shadow-md shadow-emerald-950/30"
                title="Share Clinical Report via WhatsApp, Email & Custom Templates"
              >
                <Share2 className="w-3.5 h-3.5" />
