...
const Modal: React.FC<ModalProps> = ({ isOpen, onClose, title, children, maxWidth = 'max-w-md' }) => {
  ...
  return (
    ...
    >
      <div 
        className={`bg-white dark:bg-slate-900 rounded-2xl shadow-2xl w-full ${maxWidth} max-h-[90vh] overflow-y-auto transform transition-all animate-in zoom-in-95 duration-200 border border-slate-200 dark:border-slate-800 my-auto`}
