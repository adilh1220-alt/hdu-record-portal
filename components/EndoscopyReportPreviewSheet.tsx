  ...
  return (
    ...
    >
      <div>
        ...
        >
          {/* Left Side: The Kidney Centre logo in base64 */}
        ...
        <div className={`mt-3.5 mb-1 bg-slate-900 text-white rounded-md border border-slate-950 flex items-center justify-between shadow-sm transition-all ${
          ...
          <span className={`font-mono font-bold uppercase tracking-widest text-slate-300 ${
            isCompactView ? 'text-[8.5px]' : 'text-[10px]'
          }`}>
            DIAGNOSTIC & INTERVENTIONAL SUITE
          </span>
        </div>
      ...
      <div className={`border-t border-slate-200 transition-all ${isCompactView ? 'mt-8 pt-4' : 'mt-16 pt-10'}`}>
        ...
        >
          REPORT COMPILED BY MEDILOG CLINICAL SYSTEMS. GENERATED BY:{' '}
