        ...
        <div className="flex items-center space-x-1.5">
          ...
          {isStreaming ? (
            <button
              type="button"
              onClick={stopCamera}
              className="px-2.5 py-1 bg-rose-900/40 hover:bg-rose-800/60 text-rose-300 border border-rose-700/50 rounded-lg text-[10px] font-black uppercase tracking-wider transition-all flex items-center gap-1 cursor-pointer"
            >
            ...
            <button
              ...
              className="px-3 py-1 bg-gradient-to-r from-emerald-600 to-teal-600 hover:from-emerald-500 hover:to-teal-500 text-white rounded-lg text-[10px] font-black uppercase tracking-wider transition-all flex items-center gap-1.5 shadow-md shadow-emerald-950/40 cursor-pointer animate-pulse"
            >
          ...
          <div className="flex flex-col items-center justify-center text-center p-6 space-y-3 z-10">
            ...
            <div>
              ...
              <p className="text-[11px] text-slate-400 max-w-sm mt-1">
                Connect your Olympus / Pentax HDMI capture card or webcam and click below to view live feed inside the report workspace.
              </p>
            </div>
            ...
            <button
              type="button"
              onClick={() => startCamera(selectedDeviceId)}
              className="px-4 py-2 bg-indigo-600 hover:bg-indigo-500 text-white rounded-xl text-xs font-black uppercase tracking-wider transition-all flex items-center gap-2 shadow-lg shadow-indigo-600/20 cursor-pointer active:scale-95"
            >
